...
global.gurl  =process.env.GURL  || "https://chat.whatsapp.com/KlFKWN3QWq04DKeAdjk8gw";
global.website=process.env.GURL || "https://chat.whatsapp.com/KlFKWN3QWq04DKeAdjk8gw" ; 
...
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "254702365210,254786273945,254708336448";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "254702365210,254786273945,254708336448";
...
module.exports = {
  ...
  botname : process.env.BOT_NAME  || "ωιℓℓιѕ",
